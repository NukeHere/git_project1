...
VOLUEME_Z = 1
VOLUEME_M = 1
SCREEN_RESOLATION_LIST = ['800x600', '960x720', '1040x780', 0]
...
class Nastroiki(GlavnoeMenu):
    def risovanie(self, pic, f = False):
        ...
        pygame.draw.rect(self.screen, ('#808080'), (10 * self.screen_resolution, 100 * self.screen_resolution,
                                                    150 * self.screen_resolution, 50 * self.screen_resolution))#кнопка изменения разрешения
